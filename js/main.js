...
function generatePieces() {
    for (let i = 1; i <= 8; i++) {
        pieces.push(new Piece(new Position(i, 7), "assets/whitepawn.png", PAWN, true));
        pieces.push(new Piece(new Position(i, 2), "assets/blackpawn.png", PAWN, false));
    }
    pieces.push(new Piece(new Position(1, 8), "assets/whiterook.png", ROOK, true));
    pieces.push(new Piece(new Position(8, 8), "assets/whiterook.png", ROOK, true));
    pieces.push(new Piece(new Position(1, 1), "assets/blackrook.png", ROOK, false));
    pieces.push(new Piece(new Position(8, 1), "assets/blackrook.png", ROOK, false));
    pieces.push(new Piece(new Position(2, 8), "assets/whiteknight.png", KNIGHT, true));
    pieces.push(new Piece(new Position(7, 8), "assets/whiteknight.png", KNIGHT, true));
    pieces.push(new Piece(new Position(2, 1), "assets/blackknight.png", KNIGHT, false));
    pieces.push(new Piece(new Position(7, 1), "assets/blackknight.png", KNIGHT, false));
    pieces.push(new Piece(new Position(6, 8), "assets/whitebishop.png", BISHOP, true));
    pieces.push(new Piece(new Position(3, 8), "assets/whitebishop.png", BISHOP, true));
    pieces.push(new Piece(new Position(6, 1), "assets/blackbishop.png", BISHOP, false));
    pieces.push(new Piece(new Position(3, 1), "assets/blackbishop.png", BISHOP, false));
    pieces.push(new Piece(new Position(4, 8), "assets/whitequeen.png", QUEEN, true));
    pieces.push(new Piece(new Position(4, 1), "assets/blackqueen.png", QUEEN, false));
    pieces.push(new Piece(new Position(5, 8), "assets/whiteking.png", KING, true));
    pieces.push(new Piece(new Position(5, 1), "assets/blackking.png", KING, false));
...
function castle(position) {
    ...
    let newPiece = new Piece(newRookPosition, selectedPiece.isWhite ? "assets/whiterook.png" : "assets/blackrook.png", ROOK, selectedPiece.isWhite);
    pieces.push(newPiece);
